...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .feedback, .command = "/feedback", .help_entry = "/feedback", .completion_description = "copy a diagnostic and show a GitHub issue link", .presentation_category = .product, .show_in_welcome = true },
