...
test "built-in model-facing tool contract stays byte exact" {
    ...
    try std.testing.expectEqualStrings(
        "ed8d51c79ab69c848d39e63e4fcd04c4c483780098032dcc82dd02a320340539",
        &actual_hex,
    );
}
