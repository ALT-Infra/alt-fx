...
fn buildFooterSurfaceProjection(
    ...
    const show_definition_manager = !viewer_active and !show_auth_picker and !show_settings_menu and !show_help_menu and !show_session_menu and !show_models_menu and !modal_active and ctx.definition_manager.active;
    const show_inline_catalog = show_settings_menu or show_help_menu or show_session_menu or show_models_menu or show_definition_manager;
