    ...
    return struct {
        ...
        fn resolveEscape(app: *App, was_cancel_pending: bool, now: i64) !void {
            ...
            if (was_cancel_pending) {
                ...
                if (cancelCompactCommandMenu(app) or cancelMcpMenu(app) or cancelSettingsMenu(app) or cancelHelpMenu(app) or cancelModelMenu(app) or cancelSkillsMenu(app) or cancelSessionMenu(app) or cancelOrchestrationDefinitionManager(app)) {
                    _ = disarmEscapeClear(app);
                    app.shell.render_requests.request(.footer);
                    return;
                }
